...
export default function DesktopSidebar() {
  ...
  return (
    <div
    className='hidden relative md:block min-wp[280px] max-w-[280px] h-screen overflow-
     w-full bg-primary/5 dark:bg-secondary/30 dark:text-foreground text-muted-foreground
      border-x-2 border-separate'
    >
...
export function MobileSidebar(){
    ...
    return <div className="block boarder-separate bg-background md:hidden ">
